...
import { buildSnapshot, formatNumber, formatUsd, type Candle, type StrategySnapshot } from "@/lib/market";
    ...
    <main className="shell">
      <header className="topbar">
        ...
        <div className="actions">
          ...
          <a className="icon-button" href="/" title="Refresh" aria-label="Refresh">
            <RefreshCw size={18} />
          </a>
        </div>
      </header>
          ...
          <section className="market-panel">
            <div className="pair-row">
              <div className="pair">
                ...
                <div>
                  <h2>{market.symbol}</h2>
                  <p>Binance spot · {market.timeframe} closed candles</p>
                </div>
              </div>
              <span className="pill">
                <Clock3 size={15} />
        ...
        <section className="grid">
          ...
          <InfoCard title="Execution Model" icon={<Server size={18} />}>
            <div className="checklist">
              ...
              <div className="check">
                <CheckCircle2 className="ok" size={18} />
                <span>Swing-low stop and 2:1 take profit</span>
              </div>
              <div className="check">
                <CheckCircle2 className="ok" size={18} />
                <span>EMA 21 trailing stop enabled</span>
              </div>
            </div>
          </InfoCard>
        </section>
        ...
        <section className="grid">
          ...
          <InfoCard title="Exit Rules" icon={<ArrowDownRight size={18} />}>
            <div className="checklist">
              ...
              <div className="check">
                <CircleAlert className="muted" size={18} />
                <span>Stop loss, take profit, or EMA 21 trail</span>
              </div>
            </div>
          </InfoCard>
          ...
          <InfoCard title="Deployment" icon={<Radio size={18} />}>
            <div className="checklist">
              <div className="check">
                <CheckCircle2 className="ok" size={18} />
                <span>Vercel hosts this dashboard</span>
              </div>
              <div className="check">
                <CircleAlert className="muted" size={18} />
